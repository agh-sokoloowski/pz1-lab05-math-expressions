...
public class Main {
    ...
    static void defineCircle() {
        ...
        System.out.printf("Punkt (%f,%f) leży %s koła %s", xv, yv, (fv < 0 ? "wewnątrz" : "na zewnątrz"), circle);
    }

    static void findInCircle() {
        Variable x = new Variable("x");
        Variable y = new Variable("y");
        Node circle = new Sum()
                .add(new Power(x, 2))
    ...
    public static void main(String[] args) {
        System.out.println("--- buildAndPrint() ---");
        buildAndPrint();
        System.out.println();

        System.out.println("--- buildAndEvaluate() ---");
        buildAndEvaluate();
        System.out.println();

        System.out.println("--- defineCircle() ---");
        defineCircle();
        System.out.println();

        System.out.println("--- findInCircle() ---");
        findInCircle();
        System.out.println();
